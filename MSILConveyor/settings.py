"""
Django settings for MSILConveyor project.
...
SECRET_KEY = 'django-insecure-z&(ij(m4s7jj+!az@q(z#2fdy$+vkzz3nui@(1m3)x7xt(__qs'
...
ROOT_URLCONF = 'MSILConveyor.urls'
...
WSGI_APPLICATION = 'MSILConveyor.wsgi.application'
ASGI_APPLICATION = "MSILConveyor.asgi.application"
